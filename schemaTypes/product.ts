...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'mountingHeights',
      title: 'Mounting Heights',
      type: 'internationalizedArrayString',
      group: 'accessories',
    }),
    defineField({
      name: 'includedShelfHeight',
      title: 'Included Shelf Height (mm)',
      type: 'number',
      group: 'accessories',
    }),
    defineField({
    ...
    defineField({
      name: 'requiresVesaMount',
      title: 'Requires VESA Mount',
      type: 'internationalizedArrayString',
      group: 'accessories',
    }),
    defineField({
    ...
    defineField({
      name: 'electronicPanTiltZoom',
      title: 'Electronic Pan, Tilt, Zoom',
      type: 'internationalizedArrayString',
      group: 'webcam',
    }),
    defineField({
    ...
    defineField({
      name: 'audioAndMovementFraming',
      title: 'Audio and Movement Framing',
      type: 'internationalizedArrayString',
      group: 'webcam',
    }),
    defineField({
    ...
    defineField({
      ...
      title: 'Diagonal Field Of View (degrees)',
      type: 'number',
      group: 'webcam',
    }),
    defineField({
    ...
    defineField({
      name: 'conferencePlatformCompatibility',
      title: 'Conference Platform Compatibility',
      type: 'internationalizedArrayString',
      group: 'webcam',
    }),
    defineField({
      name: 'panelCompatibility',
